        ...
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-sm-10">
                            <form class="form-horizontal" role="form" method="post" action='{{route("course.update",$course)}}'>
                               @csrf
                               @method('put')
                                ...
                                <div class='form-group'> <label for="title" class="col-sm-2 control-label">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="title" name="teacher_id" value="{{$course->teacher_id}}">
                                    </div>
                                    <span class="col-sm-4 control-label">
                                    </span>
                                </div>
                                <div class='form-group'> <label for="classesId" class="col-sm-2 control-label">
                                    ...
                                    <div class="col-sm-6">
                                        <select name="grade" id='classesId' class='form-control select2' value="{{$course->grade}}">

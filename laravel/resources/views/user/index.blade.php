                            ...
                            <div id="hide-table">
                                <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                                    ...
                                    <tbody>
                                            @foreach($user as $pr)
                                        <tr>
                                            <td data-title="#">{{ $pr -> id}}</td>
                                            <td data-title="Photo">
                                                <img src={{url('/assets/images/'.$pr->profile_photo_path)}} width="35px" height="35px" class="img-rounded" alt="" />
                                            </td>
                                            <td data-title="Name">{{$pr->name}}</td>
                                            <td data-title="Email">{{$pr->email}}</td>
                                            <td data-title="Email">{{$pr->role}}</td>

                                            <td data-title="Action">
                                                <a href="{{route('user.show',$pr)}}" class="btn btn-success btn-xs mrg" data-placement="top" data-toggle="tooltip" data-original-title="View"><i class="fa fa-check-square-o"></i></a>
